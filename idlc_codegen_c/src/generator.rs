...
static char __attribute__((unused)) __assert_float_is_32_bits[-(sizeof(float) * CHAR_BIT != 32)];
static char __attribute__((unused)) __assert_double_is_64_bits[-(sizeof(double) * CHAR_BIT != 64)];
